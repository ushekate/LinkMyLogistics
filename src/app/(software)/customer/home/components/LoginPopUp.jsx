...
// 	return (
// 		<div className="w-full min-h-screen fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-md">
// 			<div className="bg-white/60 backdrop-blur-sm shadow-xl rounded-2xl p-8 w-full max-w-md relative">
// 				{/* Close Button */}
// 				<button
// 					// onClick={onOpen}
...
// 						<ArrowRightToLine className="mr-2" /> Login
// 					</Button>
// 				</form>
...
// 					Need Help?{" "}
// 					<a href="mailto:support@greenlogistics.com" className="text-green-600 hover:underline">
// 						support@greenlogistics.com
// 					</a>
// 				</p>
// 			</div>
// 		</div>
