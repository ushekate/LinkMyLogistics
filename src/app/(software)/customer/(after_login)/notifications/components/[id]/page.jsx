...
//         <div><Megaphone size={50} className="bg-blue-400 rounded-full p-2" /></div>
//         <div>
//           <h1 className="text-2xl font-semibold">Seminar Invite: Export Trends 2025</h1>
//           <div className="flex items-center gap-2 text-sm">
//             <CalendarDaysIcon className="w-5 h-5" />
//             <span>July 15, 2025 • 4:00 PM - 6:00 PM • Zoom & In-Person at Green Ocean HQ</span>
//           </div>
//         </div>
//       </div>
...
//       <div className="bg-white shadow rounded-b-xl p-4">
//         <section className="mb-6">
//           <h2 className="flex items-center gap-2 font-semibold text-lg ml-4"><Pin className="text-foreground fill-foreground" size={18} /> Notification Overview</h2>
//           <div className="grid grid-cols-1 gap-4 max-w-full p-4 text-black">
//             <div className="border border-secondary/50 bg-secondary/10 rounded-md p-3">
//               <p className="p-1"><span className="text-secondary font-light text-sm mx-2">Title:</span> Export Trends 2025 – Seminar Invitation</p>
//               <p className="p-1"><span className="text-secondary font-light text-sm mx-2">Type:</span> Event</p>
//               <p className="p-1"><span className="text-secondary font-light text-sm mx-2">Date:</span> July 15, 2025</p>
//               <p className="p-1"><span className="text-secondary font-light text-sm mx-2">Time:</span> 4:00 PM – 6:00 PM</p>
//               <div className="sm:col-span-2">
//                 <p className="p-1"><span className="text-secondary font-light text-sm mx-2">Mode:</span> Zoom & In-Person at Green Ocean HQ</p>
//               </div>
//             </div>
...
//         {/* Description */}
//         <section className="mb-6">
//           <h2 className="flex gap-2 font-semibold text-lg mb-2 ml-4"><LucideAlignLeft size={20} className="mt-1" /> Description</h2>
//           <div className="px-4">
//             <div className="border border-secondary/50 text-sm text-secondary bg-secondary/10 rounded-md p-4">
//               <p className="mb-2">
//                 Join us for a special seminar focused on the future of shipping logistics, international compliance, and digital transformation in container freight.
...
//         {/* Action Items */}
//         <section className="mb-6">
//           <h2 className="flex gap-2 font-semibold text-lg mb-2 pl-4"><Link2Icon size={25} className="mt-1" /> Action Items</h2>
//           <div className="border border-secondary/50 bg-secondary/10 rounded-md mx-4 p-4">
//             <div className="grid grid-cols-3 gap-3">
//               <button className="bg-foreground text-white px-4 py-2 rounded-md hover:bg-blue-700 flex items-center-safe gap-2">
//                 <NotebookPen className="w-4 h-4" />
//                 Fill RSVP Form
//               </button>
//               <button className="bg-white text-foreground px-4 py-2 rounded-md border border-foreground hover:bg-foreground hover:text-white flex items-center gap-2">
...
//         {/* Attachments */}
//         <section className="mb-6">
//           <h2 className="flex gap-2 font-semibold text-lg mb-2 ml-4"><Paperclip size={18} className="mt-1.5" /> Attachments</h2>
//           <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 border border-secondary/50 bg-secondary/10 rounded-md mx-4 p-4">
//             <div className="bg-white border rounded-md p-3 flex justify-between items-center text-sm">
//               <div className="flex items-center gap-2">
//                 <FileText className="w-5 h-5 text-foreground" />
...
//         <section className="mb-6">
//           <h2 className="flex gap-2 font-semibold text-lg mb-2 ml-4"><ChartLine size={18} className="mt-1" /> Notification Metadata</h2>
//           <div className="grid grid-cols-1 gap-4 text-sm border border-secondary/50 rounded-md p-4 mx-4 text-black bg-secondary/10">
//             <p><span className="text-secondary font-light text-sm mx-2">Sent By:</span> Green Ocean Logistics Admin</p>
//             <p><span className="text-secondary font-light text-sm mx-2">Sent On:</span> July 10, 2025 – 2:30 PM</p>
//             <p className="flex items-center gap-1 mx-2 text-black">
//               <span className="text-secondary font-light text-sm">Status: </span><CheckCircle size={18} className="w-4 h-4 ml-2 text-green-600" /> Read
//             </p>
//           </div>
//         </section>
