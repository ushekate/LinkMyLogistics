        ...
        <div className="p-4 space-y-6 min-h-screen">
            <div className="py-2 border-b-4 border-secondary/50">
                <h1 className="flex gap-2 font-semibold text-2xl text-black">
                    <FileText /> View Pricing Request - #{requestId}
                </h1>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-white shadow rounded-xl p-5 text-black space-y-2">
                    ...
                    <div className='flex gap-4 items-center'>
                        <Building size={50} className='text-secondary bg-secondary/20 p-2 rounded-full' />
                        <p className="font-semibold text-lg text-black border-b-4 border-secondary/50">{customer.company}</p>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <button className="bg-blue-100 text-blue-600 flex items-center justify-center py-4 rounded-md gap-2"><Edit3 className="w-4 h-4" /> Edit Request</button>
                <button className="bg-purple-100 text-purple-600 flex items-center justify-center py-4 rounded-md gap-2"><StickyNote className="w-4 h-4" /> Add Note</button>
                <button className="bg-green-100 text-green-600 flex items-center justify-center py-4 rounded-md gap-2"><BadgeCheck className="w-4 h-4" /> Change Status: Accepted</button>
                <button className="bg-yellow-100 text-yellow-600 flex items-center justify-center py-4 rounded-md gap-2"><MessageSquare className="w-4 h-4" /> Send Message to Customer</button>
            </div>
            </div>
        </div>
    );
